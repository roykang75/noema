  ...
  const fontStack =
    font === "serif"
      ...
      : font === "mono"
        ...
        : `-apple-system, BlinkMacSystemFont, "Apple SD Gothic Neo", "Segoe UI", "Malgun Gothic", "Pretendard Variable", Pretendard, var(--font-geist-sans), ui-sans-serif, system-ui, sans-serif`;
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <input
          ...
          className="mb-4 w-full border-none bg-transparent px-[54px] text-[22px] font-bold text-gray-900 placeholder-gray-300 outline-none"
        />
